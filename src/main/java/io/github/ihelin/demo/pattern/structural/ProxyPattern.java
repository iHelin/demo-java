package io.github.ihelin.demo.pattern.structural;
...
/**
 * 代理模式
 * 为目标对象创建一个代理对象，其他对象可以通过代理对象来访问目标对象的方法，AOP、拦截器均为该模式的实践。
 * <p>
 * 总结：
...
public class ProxyPattern {
    ...
    public static void main(String[] args) {
        ...
        List list = (List) new DynamicProxy().proxy(new ArrayList());
        list.add("data");
        list.remove("data");
        list.clear();
