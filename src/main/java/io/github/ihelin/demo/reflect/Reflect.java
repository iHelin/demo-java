package io.github.ihelin.demo.reflect;
...
public class Reflect {
    ...
    public static void test01(int a, int b) throws ClassNotFoundException {
        Class c1 = Reflect.class;
        Class c2 = Class.forName("io.github.ihelin.demo.reflect.Reflect");
        // 获取指定的包名
        ...
        for (Field field : fields) {
            ...
            if (type.isArray()) { // 如果是数组类型则需要特别处理
                ...
                System.out.println("isArray " + modifier + " " + arrType + " " + name + ";");
            } else {
                System.out.println("isNotArray " + modifier + " " + type + " " + name + ";");
            }
        }
        // 获取类的构造方法
        ...
        for (Constructor constructor : constructors) {
            ...
            System.out.print("构造方法：" + modifier + " " + name + "(");
        ...
        for (Method method : methods) {
            ...
            if (returnType.isArray()) {
                ...
                System.out.print("成员方法isArray：" + modifier + " " + arrType + " " + method.getName() + "(");
            } else {
                System.out.print("成员方法isNotArray：" + modifier + " " + returnType.getName() + " " + method.getName() + "(");
            }
    ...
    public static void test02() throws InstantiationException, IllegalAccessException, SecurityException,
        ...
        Class c1 = Reflect.class;
        // 利用反射来创建类的对象
        Reflect t1 = (Reflect) c1.newInstance();
        ...
        method.invoke(t1, "方法参数");
        System.out.println("setUserName()方法：" + t1.username);
        method = c1.getDeclaredMethod("setPassWord", String.class);
        method.setAccessible(true);
        method.invoke(t1, "这是一个私有方法参数");
        System.out.println("setPassWord()方法：" + t1.password);
    }
