...
/**
 * 创建者模式
 * 当创造一个对象需要很多步骤时适合使用建造者模式。而当只需调用一个方法
...
public class BuilderPattern {
    ...
    static class Phone {
        ...
        public String toString() {
            return new ToStringBuilder(this).append(displayScreen).append(battery).append(camera)
                    .append(operatingSystem).build();
        }
